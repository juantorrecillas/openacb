...
export default function TeamStats({ teams, teamLogos = {} }) {
  ...
  return (
    ...
    >
      ...
      {/* Scatter Plot */}
      <section className={styles.analysisPanel} aria-labelledby="team-map-title">
        <div className={styles.panelHeader}>
          <div>
            <h2 id="team-map-title">Mapa de rendimiento</h2>
          </div>
        ...
        <div className={styles.chartControls}>
          ...
          <div className={styles.controlSpacer}>
            <button
              ...
              className={`${styles.secondaryButton} ${showLabels ? styles.toggleActive : ''}`}
      ...
      <section className={styles.dataSection} aria-labelledby="team-table-title">
        <div className={styles.sectionHeader}>
          <div>
            <h2 id="team-table-title">Tabla de rendimiento</h2>
            <p>Estadísticas básicas y avanzadas para cada equipo y sus rivales.</p>
          </div>
          <div className={styles.tableTools}>
            <div className={styles.viewTabs} role="group" aria-label="Tipo de estadísticas">
          <button
            onClick={() => updateUrlState({ view: 'basic' })}
            aria-pressed={viewMode === 'basic'}
            className={`${styles.viewTab} ${viewMode === 'basic' ? styles.viewTabActive : ''}`}
          >
            Básico
          </button>
          <button
            ...
            className={`${styles.viewTab} ${viewMode === 'advanced' ? styles.viewTabActive : ''}`}
          >
            Avanzado
          </button>
          <button
            onClick={() => updateUrlState({ view: 'oppBasic' })}
            aria-pressed={viewMode === 'oppBasic'}
            className={`${styles.viewTab} ${viewMode === 'oppBasic' ? styles.viewTabActive : ''}`}
          >
            Riv. Básico
          </button>
          <button
            onClick={() => updateUrlState({ view: 'oppAdvanced' })}
            aria-pressed={viewMode === 'oppAdvanced'}
            className={`${styles.viewTab} ${viewMode === 'oppAdvanced' ? styles.viewTabActive : ''}`}
          >
            Riv. Avanzado
          </button>
            </div>
      ...
      {/* Table */}
        <div className={styles.tableFrame} tabIndex={0} aria-label="Estadísticas de equipos">
