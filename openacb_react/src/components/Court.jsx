...
// Shared court palette. Keep overlays (such as the ranked zone view) on the
// same surface and line colors as the dot chart rendered by this component.
export const COURT_SURFACE_FILL = '#fffaf5'
export const COURT_LINE_COLOR = '#829ab1'
...
export default function Court({ children, width = 500, height = 470 }) {
  ...
  return (
    ...
    >
      {/* Warm paper court surface used across the analytical tools */}
      <rect x={0} y={0} width={width} height={height} fill={COURT_SURFACE_FILL} />
      ...
      <rect
        ...
        fill="#f7eee7" stroke={COURT_LINE_COLOR} strokeWidth={1.5}
      />
      ...
      <circle
        ...
        cy={ty(FREE_THROW_Y)}
        r={FT_CIRCLE_R * scale}
        fill="none" stroke={COURT_LINE_COLOR} strokeWidth={1.5}
      />
      ...
      {/* Baseline */}
      <line x1={tx(-7.5)} y1={ty(-14)} x2={tx(7.5)} y2={ty(-14)} stroke={COURT_LINE_COLOR} strokeWidth={1.5} />
      {/* Left sideline */}
      <line x1={tx(-7.5)} y1={ty(-14)} x2={tx(-7.5)} y2={ty(0)} stroke={COURT_LINE_COLOR} strokeWidth={1.5} />
      {/* Right sideline */}
      <line x1={tx(7.5)} y1={ty(-14)} x2={tx(7.5)} y2={ty(0)} stroke={COURT_LINE_COLOR} strokeWidth={1.5} />
      {/* Midcourt line */}
      <line x1={tx(-7.5)} y1={ty(0)} x2={tx(7.5)} y2={ty(0)} stroke={COURT_LINE_COLOR} strokeWidth={1.5} />
