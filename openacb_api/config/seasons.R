...
SEASONS <- tibble::tribble(
  ~season_id, ~season_name, ~edition_id, ~folder_name, ~year_label, ~regular_season_rounds, ~is_complete,
  2017,       "2016-2017",  81,          "2016-2017",  "17",        34,                     TRUE,
  2018,       "2017-2018",  82,          "2017-2018",  "18",        34,                     TRUE,
  2019,       "2018-2019",  83,          "2018-2019",  "19",        34,                     TRUE,
  2020,       "2019-2020",  84,          "2019-2020",  "20",        23,                     TRUE,
  2021,       "2020-2021",  85,          "2020-2021",  "21",        38,                     TRUE,
  2022,       "2021-2022",  86,          "2021-2022",  "22",        34,                     TRUE,
  2023,       "2022-2023",  87,          "2022-2023",  "23",        34,                     TRUE,
  2024,       "2023-2024",  88,          "2023-2024",  "24",        34,                     TRUE,
  2025,       "2024-2025",  89,          "2024-2025",  "25",        34,                     TRUE,
  2026,       "2025-2026",  90,          "2025-2026",  "26",        34,                     TRUE
)
...
API_CONFIG <- list(
  ...
  # bearer token comes from the environment, never from source control
  bearer_token = Sys.getenv("ACB_BEARER_TOKEN")
)
